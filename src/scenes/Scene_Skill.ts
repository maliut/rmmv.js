...
export class Scene_Skill extends Scene_ItemBase {
  ...
  createSkillTypeWindow() {
    ...
    this._skillTypeWindow = new Window_SkillType().initialize(0, wy)
  ...
  createStatusWindow() {
    ...
    this._statusWindow = new Window_SkillStatus().initialize(wx, wy, ww, wh)
  ...
  createItemWindow() {
    ...
    this._itemWindow = new Window_SkillList().initialize(wx, wy, ww, wh)
